...
num_squares_x = 14  # Number of squares along X
num_squares_y = 10  # Number of squares along Y
square_size = 20    # mm
...
ax.quiver(0, 0, 0, 0, axis_length, 0, color='green', arrow_length_ratio=0.15)
ax.quiver(0, 0, 0, 0, 0, axis_length, color='blue', arrow_length_ratio=0.15)
